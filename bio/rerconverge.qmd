...
以前のバイナリインストールや gfortran を用いたソースコードインストールは非推奨となった:
<https://github.com/nclark-lab/RERconverge/wiki/Install#legacy-mac-installation-fixes-gfortran-docker-and-binaries>
