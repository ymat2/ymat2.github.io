...
1. 種ごと、遺伝子ファミリーごとの遺伝子数のテーブル(タブ区切り)。
  [OrthoFinder](./orthofinder.qmd) とか OrthoMCL とかでつくる。
...
1. Newick 形式の系統樹。binary, rooted, ultrametric である必要がある。
...
このp値が事前に定めた有意水準 (例えば0.05) を下回ったものが
...
[CAFE4](./cafe.qmd) のトラブルシューティングも参照。
