...
: クオリティコントロール
: リードマッピング、バリアントコール
: <span style="color:#CCC;">SNP アノテーション</span>
: <span style="color:#CCC;">IGV/R を用いた可視化</span>
...
- 参照配列: [ASM584v2](https://bacteria.ensembl.org/Escherichia_coli_str_k_12_substr_mg1655_gca_000005845/Info/Index) (Ensembl59)
- Illumina ショートリード: [SRR030253](https://www.ncbi.nlm.nih.gov/sra/?term=SRR030253)
